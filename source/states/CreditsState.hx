...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Mikolka9144',	'mikolka', 'Ported the soundtray and screenshot plugin to Psych Engine', 'https://gamebanana.com/members/3329541', '2ebcfa'],
			['Moonlight_Catalyst', 'moonlight_catalyst', 'Ported ghost notes and constant scoring to Psych Engine', 'https://www.youtube.com/channel/UCmvsORFe7ZldiG4budmzELA', '9764B7'],
