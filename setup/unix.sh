...
haxelib install flixel 5.9.0 && haxelib set flixel 5.9.0
haxelib install flixel-addons 3.3.2 && haxelib set flixel-addons 3.3.2
...
haxelib install hxdiscord_rpc 1.2.4 && haxelib set hxdiscord_rpc 1.2.4
