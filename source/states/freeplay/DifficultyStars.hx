...
import states.freeplay.FreeplayFlames;
...
class DifficultyStars extends FlxSpriteGroup
{
  ...
  public function new(x:Float, y:Float)
  {
    ...
    Paths.loadAnimateAtlas(stars, 'persona/menus/freeplay/freeplayStars');
    stars.anim.addBySymbol('anim', 'diff stars', 24, false);
    stars.anim.play('anim', true);
    add(stars);
